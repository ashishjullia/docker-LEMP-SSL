...
mkdir -p ./php/code/apps/wordpress
wget -P ./php/code/apps/wordpress https://wordpress.org/latest.tar.gz
tar -xzvf ./php/code/apps/wordpress/latest.tar.gz -C ./php/code/apps/wordpress
